...
const FIELD_SECTIONS = [i for i in 0:11]                    # All field sections
const NON_SCORING_FIELD_SECTIONS = [i for i in 1:10]        # Field sections that aren't end zones
...
const FIELD_GOAL_MERCY_SECTION = 2                          # If a field goal inside this the ball is placed on the 25
...
const FIRST_DOWN_TO_GO = 1                                  # Dist to first down if first down 
